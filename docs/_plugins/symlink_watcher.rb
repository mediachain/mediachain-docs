# This file is from https://github.com/willnorris/willnorris.com/blob/master/src/_plugins/symlink_watcher.rb
# LICENSE file url: https://github.com/willnorris/willnorris.com/blob/master/LICENSE
# Note that this is ignored by GitHub page's automatic Jekyll builds, but it's useful during
# local development.
