...
This mechanism allows developers using Mediachain to build dynamic decentralized applications with user-generated content in a way that other systems can not.
...
For developers looking to reuse data in the Mediachain, this means they have a single, standard API to interact with the thousands of datasets in the system, enabling completely decentralized discovery and collaboration on data.
